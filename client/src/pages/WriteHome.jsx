  ...
  return (
    <div style={{
      ...
      <main style={{ maxWidth: 680, margin: '0 auto', padding: '20px 16px 90px', position: 'relative', zIndex: 3 }}>
        ...
        {/* Blind Peer Grade entry point */}
        <motion.div initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.088 }}>
          <OrnateCard
            role="button" tabIndex={0}
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ fontSize: 14.5, fontWeight: 800, color: '#F0EDE6', marginBottom: 3 }}>Blind Peer Grade</div>
              <div style={{ fontSize: 11.5, color: 'rgba(240,237,230,0.5)', fontWeight: 600 }}>
                Score an anonymous classmate's essay, then compare to the AI
              </div>
            </div>
            <div style={{ fontSize: 13, fontWeight: 800, color: '#F5A623' }}>→</div>
          </OrnateCard>
